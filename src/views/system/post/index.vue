<template>
  <div class="app-container">
    ...
    <el-table class="loading-area" :data="postList" @selection-change="handleSelectionChange">
...
<script>
import { listPost, getPost, deletePost, addPost, updatePost } from "@/api/system/post";
