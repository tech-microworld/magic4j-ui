<template>
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
              ...
              <el-form-item label="设备所在区域" prop="deviceArea">
                <el-input
              ...
              <el-form-item label="设备铺设点位名称" prop="devicePtName">
                <el-input
                        v-model="queryParams.devicePtName"
                        placeholder="请输入设备铺设点位名称"
                        clearable
                        size="small"
                        @keyup.enter.native="handleQuery"
                />
              ...
              <el-form-item label="地理位置名称" prop="gePoName">
                <el-input
                        v-model="queryParams.gePoName"
              ...
              <el-form-item label="设备维护人员姓名" prop="maName">
                <el-input
                        v-model="queryParams.maName"
                        placeholder="请输入设备维护人员姓名"
                        clearable
                        size="small"
                        @keyup.enter.native="handleQuery"
                />
            </el-form-item>
              <el-form-item label="设备维护人员电话" prop="maPhone">
                <el-input
                        v-model="queryParams.maPhone"
                        placeholder="请输入设备维护人员电话"
                        clearable
                        size="small"
                        @keyup.enter.native="handleQuery"
                />
            </el-form-item>
              <el-form-item label="设备所在国家" prop="country">
                <el-input
                        v-model="queryParams.country"
                        placeholder="请输入设备所在国家"
                        clearable
                        size="small"
                        @keyup.enter.native="handleQuery"
                />
            </el-form-item>
              <el-form-item label="设备所在省份" prop="province">
                <el-input
                        v-model="queryParams.province"
                        placeholder="请输入设备所在省份"
                        clearable
                        size="small"
                        @keyup.enter.native="handleQuery"
                />
            </el-form-item>
              <el-form-item label="设备所在城市" prop="city">
                <el-input
                        v-model="queryParams.city"
                        placeholder="请输入设备所在城市"
                        clearable
                        size="small"
                        @keyup.enter.native="handleQuery"
                />
            </el-form-item>
              <el-form-item label="设备所在地区" prop="district">
                <el-input
                        v-model="queryParams.district"
                        placeholder="请输入设备所在地区"
                        clearable
                        size="small"
                        @keyup.enter.native="handleQuery"
                />
        ...
        <el-table ref="pageTable" class="loading-area" :data="dataList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="设备所在区域" align="center" prop="deviceArea" v-if="columnVisibles[3]"/>
            <el-table-column label="设备铺设点位名称" align="center" prop="devicePtName" v-if="columnVisibles[4]"/>
            ...
            <el-table-column label="地理位置名称" align="center" prop="gePoName" v-if="columnVisibles[7]"/>
            <el-table-column label="设备状态" align="center" prop="state" v-if="columnVisibles[8]"/>
            <el-table-column label="设备维护人员姓名" align="center" prop="maName" v-if="columnVisibles[9]"/>
            <el-table-column label="设备维护人员电话" align="center" prop="maPhone" v-if="columnVisibles[10]"/>
            <el-table-column label="设备所在国家" align="center" prop="country" v-if="columnVisibles[11]"/>
            <el-table-column label="设备所在省份" align="center" prop="province" v-if="columnVisibles[12]"/>
            <el-table-column label="设备所在城市" align="center" prop="city" v-if="columnVisibles[13]"/>
            <el-table-column label="设备所在地区" align="center" prop="district" v-if="columnVisibles[14]"/>
            <el-table-column label="创建人" align="center" prop="createUser" v-if="columnVisibles[15]"/>
            <el-table-column label="创建时间" align="center" prop="createTime" v-if="columnVisibles[16]"/>
            <el-table-column label="更新人" align="center" prop="updateUser" v-if="columnVisibles[17]"/>
            <el-table-column label="更新时间" align="center" prop="updateTime" v-if="columnVisibles[18]"/>
            <el-table-column label="删除标识(0:正常，1:已删除)" align="center" prop="deleteFlag" v-if="columnVisibles[19]"/>
        ...
        <el-dialog :title="title" :visible.sync="open" width="500px">
            <el-form ref="form" :model="form" :rules="rules" label-width="100px">
                  ...
                  <el-form-item label="设备状态" prop="state">
                    <el-input v-model="form.state" placeholder="请输入设备状态" />
                </el-form-item>
                  <el-form-item label="设备维护人员姓名" prop="maName">
                    <el-input v-model="form.maName" placeholder="请输入设备维护人员姓名" />
                </el-form-item>
                  <el-form-item label="设备维护人员电话" prop="maPhone">
                    <el-input v-model="form.maPhone" placeholder="请输入设备维护人员电话" />
                </el-form-item>
                  <el-form-item label="设备所在国家" prop="country">
                    <el-input v-model="form.country" placeholder="请输入设备所在国家" />
                </el-form-item>
                  <el-form-item label="设备所在省份" prop="province">
                    <el-input v-model="form.province" placeholder="请输入设备所在省份" />
                </el-form-item>
                  <el-form-item label="设备所在城市" prop="city">
                    <el-input v-model="form.city" placeholder="请输入设备所在城市" />
                </el-form-item>
                  <el-form-item label="设备所在地区" prop="district">
                    <el-input v-model="form.district" placeholder="请输入设备所在地区" />
                </el-form-item>
                 </el-form>
    ...
    export default {
        ...
        data() {
            return {
                ...
                upload: {
                    ...
                    // 上传的地址
                    url: process.env.VUE_APP_BASE_API + "/api/demo/device/importData"
                },
                ...
                columnVisibles: new Array(20).fill(true),//设置列可见性
                ...
                rules: {
                     ...
                     country: [
                        { required: true, message: "设备所在国家不能为空", trigger: "blur" }
                    ],
                     province: [
                        { required: true, message: "设备所在省份不能为空", trigger: "blur" }
                    ],
                     city: [
                        { required: true, message: "设备所在城市不能为空", trigger: "blur" }
                    ],
                     district: [
                        { required: true, message: "设备所在地区不能为空", trigger: "blur" }
                    ],
                }
            };
        },
        ...
        methods: {
            ...
            downloadImportTemplate() {
                ...
                window.open(process.env.VUE_APP_BASE_API+"/api/demo/device/import/template?Authorization="+getToken());
            },
            // 文件上传中处理
